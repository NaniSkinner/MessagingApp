...
Day 1: Foundation & Auth [ ] 0/12 tasks  
...
- [x] **Install Required Software**
  - [x] Install Node.js (v18+) ✅ v23.5.0
  - [x] Install Xcode (latest version) ✅ v26.0.1
  - [x] Install Expo CLI globally: `npm install -g expo-cli` ✅ v6.3.12
  - [x] Install EAS CLI: `npm install -g eas-cli` ✅ v16.24.1
...
- [x] **Development Tools** ✅
  - [x] Install iPhone simulator (if using Mac) ✅ (Xcode installed)
